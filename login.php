       ...
       <div class="container">
          <div class = "row">
            <div class="col col-12 text center pt-5 mt-5">
                <form name="formRegistration" method="post" action="public/actions/login.php" onsubmit="return validateformLogin()">
                   <?php if (!empty($_GET['error'])) { ?>
                        <div class="alert alert-danger alert-styled-left">Login Error</div>
                    <?php } ?> 
                
                       <h3 class="home-title">
                         <span>Welcome Traveller again!</span>
                      ...
                      <div class="col align-self-center" >
                        <div class = "form-group">
                         <div class="action-Form_register_login" title="Login">
                            <input type="hidden" name="csrf" value= "<?php echo User::getCsrf(); ?>">
                            <input type="submit" value="Log in" class="btn bn53"></input>
                         </div>
                        </div>
                      </div>
                      <p class="text-center">New around here? <a href="register.php">Sign up</a> </p>
                </form>
